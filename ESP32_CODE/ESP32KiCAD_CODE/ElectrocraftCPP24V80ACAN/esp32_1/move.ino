...
void move_speed(byte CPP){
  ...
  canMsg.data[0] = 0x20;
  canMsg.data[1] = Motor1Data.set_Move_speed & 0xFF;
  canMsg.data[2] = (Motor1Data.set_Move_speed >> 8) & 0xFF;
  canMsg.data[3] = (Motor1Data.set_Move_speed >> 16) & 0xFF;
  canMsg.data[4] = (Motor1Data.set_Move_speed >> 24) & 0xFF;
